                ...
                <form id="search-form" method="GET" action="{{ route('children.index') }}" onsubmit="handleSearchSubmit(event)" class="flex">
                    <div class="flex rounded-md shadow-sm">
                        <div class="relative flex-grow focus-within:z-10">
                            ...
                            <input type="text" name="search" id="mobile-search-candidate"
                                   class="block w-full rounded-none rounded-l-md border-0 py-2.5 pl-10 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:hidden"
                                   placeholder="Search" value="{{ request('search') }}">
                            <input type="text" name="search" id="desktop-search-candidate"
                                   class="hidden w-full rounded-none rounded-l-md border-0 py-2.5 pl-10 text-sm leading-6 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:block"
                                   placeholder="Search children" value="{{ request('search') }}">
                        </div>
